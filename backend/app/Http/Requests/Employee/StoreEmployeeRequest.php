...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Government IDs
            'sss_number' => ['required', 'string', 'max:20', 'unique:employees,sss_number'],
            'tin' => ['required', 'string', 'max:20', 'unique:employees,tin'],
            'phil_health_number' => ['required', 'string', 'max:20', 'unique:employees,phil_health_number'],
            'pag_ibig_number' => ['required', 'string', 'max:20', 'unique:employees,pag_ibig_number'],
